...
# Purpose: Extends from P9 and practices reading in / manipulating data.
# This program creates a list of geo points from file read in, asks the user #for a location and finds the closest location from the data read in. 
...
# Header function
def header():
    text = "This program finds the distance between a list of predetermined locations read in from a file and the location you provide. It then calculates which location you are closer to."
...
try:
    while user_continue == True:
        ...
        print()
        print(f"{user_location_name.capitalize()} is closer to{closest_point[1]} with a distance of {closest_point[0]:.2f} km\n")
